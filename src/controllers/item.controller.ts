...
export class ItemController {
  ...
  async findById(@param.path.number('id') id: number, @param.filter(Item, {exclude: 'where'}) filter?: FilterExcludingWhere<Item>): Promise<Item> {
  ...
  async replaceById(@param.path.number('id') id: number, @requestBody() item: Item): Promise<void> {
